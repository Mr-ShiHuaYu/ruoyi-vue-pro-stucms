<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" v-if="checkPermi(['stucms:teacher:update','stucms:teacher:delete'])">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)" v-hasPermi="['stucms:teacher:update']">修改
          </el-button>
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['stucms:teacher:delete']">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
